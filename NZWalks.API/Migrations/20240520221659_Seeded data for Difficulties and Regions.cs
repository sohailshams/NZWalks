...
{
    /// <inheritdoc />
    public partial class SeededdataforDifficultiesandRegions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("06a43790-0851-42f7-a6a3-a898fb3e4481"), "Hard" },
                    { new Guid("789c59d3-f81a-4b5d-b3cf-577f0de537e0"), "Medium" },
                    { new Guid("c9a717c1-9b4a-4d35-beee-830482560c08"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("06a43790-0851-42f7-a6a3-a898fb3e4481"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("789c59d3-f81a-4b5d-b3cf-577f0de537e0"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c9a717c1-9b4a-4d35-beee-830482560c08"));
